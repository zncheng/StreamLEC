...
int main(int argc, char* argv[]) {
    ...
    afs::Worker<Message, Message, Message, struct afs::NullClass>* worker = 
        new afs::Worker<Message, Message, Message, struct afs::NullClass>(std::string(worker_name), worker_id, std::string(""), num_compute_thread);
    ...
    afs::UpThreadNet<Message, struct afs::NullClass>* i_thread = new afs::UpThreadNet<Message, struct afs::NullClass>(num_in, num_compute_thread);
    ...
    worker->AddMainThread(processor_thread);
