...
// note: add headers declared in removed files
#include "options.hpp"
//#include "epoll.hpp"
...
namespace afs_zmq
{
    ...
    // note: 0MQ use io_object to maintain poller
    ...
    private:
        ...
        // note: maintain poller directly, not need "io_object" any more 
        //epoll_t *poller;
        afs::InCallbackBase* in_callback_;
        afs::OutCallbackBase** out_callbacks_;

        // note: maintain options directly, not need "own" any more
        ...
        //  note: modify to store peer_addr in the argument
