...
bool afs_zmq::tcp_connecter_t::out_event ()
{
    ...
    //  Create the engine object for this connection, enable auto_reconnect after failrue
    stream_engine_t *engine = new (std::nothrow)
        stream_engine_t (fd, options, endpoint, in_callback_, out_callback_, true, worker_id_);
    alloc_assert (engine);

    //following constructor disable auto_reconnect by default
    //stream_engine_t *engine = new (std::nothrow)
